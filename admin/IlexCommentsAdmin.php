...
namespace IlexComments\Admin;

class IlexCommentsAdmin
{
    ...
    public function enqueueStyles()
    {
        ...
        wp_enqueue_style(
            $this->pluginName,
            plugin_dir_url(__FILE__) . 'css/ilex-comments-admin.css',
            [],
            $this->version,
            'all'
        );
    ...
    public function enqueueScripts()
    {
        ...
        wp_enqueue_script(
            $this->pluginName,
            plugin_dir_url(__FILE__) . 'js/ilex-comments-admin.js',
            ['jquery'],
            $this->version,
            false
        );
